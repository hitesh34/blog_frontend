      ...
      <div className="bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl">From your blog</h2>
            ...
            {posts.map((post) => (
              ...
              <div className="max-w-xl">
                ...
                <div className="group relative center">
                  ...
                  <p className="mt-5 line-clamp-3 text-sm leading-6 text-gray-600 center">{post.content}</p>
                </div>
                <div className="relative mt-8 flex items-center gap-x-4">
                  ...
                  <div className="text-sm leading-6">
                    {post.author ? (
                      ...
                      <p className="text-gray-900">Unknown Author</p>
                    )}
                    {post.author ? (
